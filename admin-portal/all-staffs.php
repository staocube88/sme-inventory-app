	...
	<?php require_once ("header.php")?>
		...
		<div class="page-name-div">
			<div class="page-name">
				...
				<h1><i class="fa fa-users"></i> All Staffs</h1>
		...
		<?php
	$userprofilequery = mysqli_query ($conn,"SELECT * FROM `staff_tab`") or die ('cannot select staff');
	$count=0;
