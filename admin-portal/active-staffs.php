...
<title>Active Staffs - IVSM </title>
</head>
	...
	<?php require_once ("header.php")?>
		...
		<div class="page-name-div">
			<div class="page-name">
				...
				<h1><i class="fa fa-user-check"></i> Active Staffs</h1>
		...
		<?php
	$userprofilequery = mysqli_query ($conn,"SELECT * FROM `staff_tab` WHERE status_id='A'") or die ('cannot select staff');
	$count=0;
...
?>
		...
		<?php
            ...
            <div class="search-alert-div">
              <i class="fa fa-stop"></i> No Active Staff
            </div>     
        <?php }?>
</div>
