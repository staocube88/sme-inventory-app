...
<div class="body-div">
    ...
    <div class="page-name-div">
        <div class="page-name">
            <h1><i class="fa fa-history"> </i> Product Load Report History Search Result</h1>  
        </div>
    </div>
...
<table  class="list-table">
    ...
    $loadproductquery = mysqli_query ($conn,"SELECT * FROM `load_product_tab` WHERE product_id='$product_id' AND DATE(date_entered) BETWEEN '$date_from' AND '$date_to'") or die ('cannot select load product tab');
    $count=0;
