...
<div class="body-div">
    ...
    <div class="page-name-div">
        <div class="page-name">
            <h1><i class="fa fa-history"> </i> Stock Load Report History <?php echo $date_from;?> and <?php echo $date_to;?></h1>  
        </div>
    </div>
...
<table  class="list-table">
    ...
    $loadproductquery = mysqli_query ($conn,"SELECT * FROM `load_stock_tab` WHERE voucher_id='$voucher_id' AND denomination_id='$denomination_id' AND DATE(date_entered) BETWEEN '$date_from' AND '$date_to'") or die ('cannot select load stock tab');
    $count=0;
