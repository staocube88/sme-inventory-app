...
<div class="body-div">
    ...
    <div class="page-name-div">
        <div class="page-name">
            <h1><i class="fa fa-history"> </i> Voucher Order History</h1>  
        </div>
    </div>
...
<table  class="list-table">
    ...
    <?php
    $orderquery = mysqli_query ($conn,"SELECT * FROM `order_voucher_tab`") or die ('cannot select order');
    $count=0;
    ...
    <tr>
      ...
      <a href="voucher-receipt.php?order_id=<?php echo $order_id?>">
