...
<title>Suspended Staffs - IVSM </title>
</head>
<body>
	...
	<?php require_once ("header.php")?>
		...
		<div class="page-name-div">
			<div class="page-name">
				...
				<h1><i class="fa fa-user-slash"></i> Suspended Staffs</h1>		
		</div>	
		</div>
		...
		<?php
	$userprofilequery = mysqli_query ($conn,"SELECT * FROM `staff_tab` WHERE status_id='S'") or die ('cannot select staff');
	$count=0;
...
?>
		...
		<?php
            ...
            <div class="search-alert-div">
              <i class="fa fa-stop"></i> No Suspended Staff
            </div>     
        <?php }?>
</div>
