...
<div class="body-div">
    ...
    <div class="page-name-div">
        <div class="page-name">
            <h1><i class="fa fa-history"> </i>  Product Sold History between <?php echo $date_from;?> and <?php echo $date_to;?></h1>  
        </div>
    </div>
...
<table  class="list-table">
    ...
    <?php
    $loadproductquery = mysqli_query ($conn,"SELECT * FROM `cart_tab` WHERE DATE(date_entered) BETWEEN '$date_from' AND '$date_to' AND product_id='$product_id' AND order_status_id='S'") or die ('cannot select cart tab');
    $count=0;
