...
/////// To fetch user details into profile page
        $userprofilequery = mysqli_query ($conn,"SELECT * FROM `staff_tab` WHERE `user_id` = '$user_profile_id'") or die ('cannot select staff');
	...
	$pro_last_name=$userprofiledata['last_name'];
        ...
        $pro_last_login_date=$userprofiledata['last_login_date'];
	...
	<div class="page-name">
        ...
        <div class="profile-div">
            <div class="title-div">
                ...
                <?php if($loguser_id==$user_profile_id){?>       
        ...
        <form action="../connection/code.php?action=update_users_profile&user_profile_id=<?php echo $user_profile_id?>"  enctype="multipart/form-data" method="post">
                <div class="profile-pix">                                        
                <img src="upload/user-passport/<?php echo $pro_passport?>" alt="<?php echo $pro_fullname?> logo"/>                     
                </div>
        ...
        <div class="profile-details">
                ...
                <option value="<?php echo $pro_role_id?>" selected><?php echo $pro_role_name?></option>
                <?php
                ...
                <option value="<?php echo $pro_status_id?>"><?php echo $pro_status_name?></option>
                <?php
                ...
                <input id="last_login_date" name="last_login_date" type="text" class="text-field" placeholder="last_login_date" title="LAST LOGIN DATE" value="<?php echo $pro_last_login_date?>" readonly>
