...
<div class="body-div">
      ...
      <form method="post" enctype="multipart/form-data" action="product-search-result.php">   
       <div class="search-div">
        <input class="box" type="text" name="txt_search" placeholder="TYPE HERE TO SEARCH FOR A PRODUCT...">	
...
<?php
	$productprofilequery = mysqli_query ($conn,"SELECT * FROM `product_tab` WHERE category_id='$category_id' AND product_status='A'") or die ('cannot select product');
	$count=0;
    ...
    $count++;
            ...
            $categorydata=mysqli_fetch_array($productcategoryquery);
...
?>           
            ...
            <div class="pix-div"><img src="../admin-portal/upload/product-picture/<?php echo $productpro_picture?>" alt="<?php echo $productpro_name?>"/></div>
              <div class="text">
