...
<table  class="list-table">
    ...
    <?php
    $orderquery = mysqli_query ($conn,"SELECT * FROM `order_tab` WHERE staff_id = '$loguser_id'") or die ('cannot select order');
    $count=0;
    ...
    <tr>
      ...
      <a href="../admin-portal/receipt.php?order_id=<?php echo $order_id?>">
    ...
    <tr class="title">
        ...
        <td>ACTION</td>
            ...
            <div class="search-alert-div">
              <i class="fa fa-search"></i> No Record Found </div>     
            <?php }?>
</div>
