...
<?php
	$orderquery = mysqli_query ($conn,"SELECT * FROM `money_transfer_tab` WHERE transaction_id = '$transaction_id'") or die ('cannot select transaction');
	$orderdata=mysqli_fetch_array($orderquery);	
        ...
        $order_total_amount=$orderdata['amount'];
...
<div class="body-div">
        ...
        <div class="page-name-div">
			<div class="page-name">
					<h1><i class="fa fa-check"></i> Transfer Successful</h1>
			</div>
        </div>
        ...
        <div class="registration-success-div">
                ...
                <div class="btn-div"><span> <?php echo $staff_first_name?> <?php echo $staff_last_name?> </span> Has Processed A Transfer Of <span> <s>N</s> <?php echo number_format($order_total_amount) ?>  </span>and Has been Received</div>
